    ...
    <div>
      ...
      <main className="pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* Hero Image Section */}
          {/* ✅ Hero Image Section — updated properly for responsiveness */}
          <div className="relative mb-16 reveal stagger-2">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-muted rounded-lg overflow-hidden">
              <div className="w-full aspect-[4/3]">
                <img
                  src="/lovable-uploads/ebc115e1-483b-42cf-9185-31eb45b574cb.png"
                  alt="Araku Coffee Branding 1"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
            ...
            {/* Added smaller image to the right */}
            <div className="lg:col-span-1 flex justify-center mt-8 lg:mt-0">
              <img
                src="/assets/coffee.png" // Replace with the correct image path
                alt="Araku Coffee Branding"
                className="w-56 h-auto object-cover rounded-lg" // Adjust size here (w-48 is about 12rem width)
              />
            </div>
          </div>
          ...
          <div className="aspect-[21/9] bg-muted rounded-lg overflow-hidden mb-16 reveal stagger-8 relative">
            <img
